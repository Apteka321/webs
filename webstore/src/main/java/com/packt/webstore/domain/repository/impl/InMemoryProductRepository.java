...
public class InMemoryProductRepository implements ProductRepository {
	...
	public InMemoryProductRepository() {
		...
		tablet_Nexus.setDescription(
				"Google Nexus 7 is the lightest 7 inchtablet With a quad-core Qualcomm Snapdragon™ S4 Pro processor");
	...
	public List<Product> getProductsByManufacturer(String manufacturer) {
		...
		for (Product product : listOfProducts) {
			//System.out.println(product.getManufacturer() + " " + manufacturer + " = " + product.getManufacturer().equalsIgnoreCase(manufacturer));
